...
** Org-mode
   ...
   #+END_SRC
** Org-roam
Thanks system-crafters for the basic configuration.
#+BEGIN_SRC emacs-lisp
  ...
  (org-roam-daily-directory "~/Notes/roam/dailies")
...
#+BEGIN_SRC emacs-lisp
    (if (eq system-type 'darwin)
        (progn
          (message "Running on macOS: I hope you have a good reason to.")
          (setq mac-right-option-modifier nil)
          (keymap-global-set "M-m" 'set-mark-command) ; just because I didn't figure out how to unmap C-SPC on macos
          (add-to-list 'exec-path "/Library/TeX/texbin")
          (add-to-list 'exec-path "/Users/mnativel/Library/Python/3.9/bin")
          (add-to-list 'exec-path "/Users/mnativel/.cargo/bin")))
#+END_SRC
* Theme
  #+BEGIN_SRC emacs-lisp
